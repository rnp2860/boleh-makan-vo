    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="w-full max-w-md bg-white min-h-screen shadow-2xl relative flex flex-col">
        ...
        <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-200 h-20 flex justify-around items-end pb-4 z-50 print:hidden">
          ...
          {/* 2. REPORTS */}
          <Link href="/reports" className={`flex flex-col items-center gap-1 w-14 ${isActive('/reports')}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* 4. PROFILE */}
          <Link href="/profile" className={`flex flex-col items-center gap-1 w-14 ${isActive('/profile')}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
